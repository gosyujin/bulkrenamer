	...
	if *o.IsAnsi {
		logConfig = `
		  <seelog type="adaptive" mininterval="200000000" maxinterval="1000000000" critmsgcount="5">
		    <formats>
		      <format id="console" format="%EscM(36)[bulkrenamer]%EscM(39) %EscM(32)%Date(2006-01-02T15:04:05Z07:00)%EscM(39) %EscM(33)[%File:%FuncShort:%Line]%EscM(39) %EscM(46)[%LEVEL]%EscM(49) %Msg%n" />
		      <format id="plane" format="[bulkrenamer] %Date(2006-01-02T15:04:05Z07:00) [%File:%FuncShort:%Line] [%LEVEL] %Msg%n" />
		    </formats>
		    <outputs>
